...
{
    public class PriorityArrayTypedQueueKB:IQueue
    {
        public object[] Queue;
        private int front = -1;
        private int count = 0;
        ...
        public string Listele()
        {
            ...
            {
                //Listeleme işleminde ToplamSureHesapla(iSure) çağırılarak her müşterinin işlem süresi küçükten büyüğe sıralandığında kuyrukta kalma süresi hesaplandı ve yazdırıldı.
